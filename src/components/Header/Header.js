        ...
        <section className={styles.section}>
            ...
            >
                <div className={styles.sliderWrapper}>
                    <StaticImage style={{minHeight: "200px"}} src="../../images/slider_1.jpg" alt="car body waxing" />
                ...
                <div className={styles.sliderWrapper}>
                    <StaticImage style={{minHeight: "200px"}} src="../../images/slider_2.jpg" alt="car exterior and interior cleaning" />
                    <div className={styles.container}>
                ...
                <div className={styles.sliderWrapper}>
                    <StaticImage style={{minHeight: "200px"}} src="../../images/slider_3.jpg" alt="car interior cleaning" />
                    <div className={styles.container}>
